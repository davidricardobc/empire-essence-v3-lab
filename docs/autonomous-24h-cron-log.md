...
### Job 23 - 2026-08-01 15:42
- Foco: Iniciar curaduria perfume por perfume de notas reales para mejorar filtros y autoridad del catalogo.
- Por que tome este camino: David pidio revisar perfume por perfume para que las notas coincidan con el original y el cliente sienta que Empire Essence sabe de perfumeria. El caso visible era `citrico fiesta`, donde el filtro ya mejoro pero la calidad del dato podia mejorar.
- Que estudie: `products.generated.json`, `product-search.ts`, el lote de prioridad comercial/top ventas y fuentes externas de casas oficiales, Fragrantica, Sephora y retailers con piramide clara.
- Hallazgos: Varias fragancias clave estaban bien alineadas, pero otras tenian notas incompletas o importadas con traduccion floja. El error mas claro estaba en `Fiesta` / Paris Hilton Can Can: aparecia `naranja silvestre`, cuando la referencia publica apunta a orquidea silvestre y flor de naranjo. Tambien faltaban notas de precision en Sauvage, Good Girl, Black Opium, Baccarat Rouge 540, Arabians Tonka, Invictus Legend, Black XS, 212 VIP Rose y Scandal.
- Cambios: Se amplio la busqueda citrica con clementina, naranja, mandarina, lima, toronja, yuzu, neroli y petit grain; se corrigio el primer lote de notas/familias/ocasiones; `Fiesta` queda floral/frutal/almizclada y entra por busquedas citricas reales; se creo `docs/perfume-notes-curation.md` con metodo, lote 1, fuentes y siguientes lotes.
